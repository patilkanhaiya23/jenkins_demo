    		...
    		<div class="navbar-header">
    			...
    			<a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
    				<div class="dropdown">
    					...
    					<div class="dropdown-content">
    						...
    						<p><a href="<?php echo site_url('CashAndChequeController/DesktopBill');?>">Cheque Deposit Slip</a></p><p><a href="<?php echo site_url('CashAndChequeController/ChequeReconcilation');?>">Cheque Reconciliation</a></p> 
    						<p><a href="<?php echo site_url('CashAndChequeController/BounceCheques');?>">Bounce Cheques</a></p>  
    						<p><a href="<?php echo site_url('CashAndChequeController/CheckRegister');?>">Cheque Register</a></p> 
    					</div>
    				</div> 
    			</a>
    			<a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
    				<div class="dropdown">
    					...
    					<div class="dropdown-content">
    						<p><a href="<?php echo site_url('CashBookController/EVauchers');?>">E-Vauchers</a></p>  
    						<p><a href="<?php echo site_url('');?>">Accounting Entries</a></p> 
    					</div>
    				</div> 
    			</a>
    			<a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
    				<div class="dropdown">
    					<span class="navbar-brand">Dilivery Slip
    						<i class="fa fa-caret-down"></i>
    					</span>
    					<div class="dropdown-content">
    						<p><a href="<?php echo site_url('DeliverySlipController');?>">New Tansaction</a></p>      
    						<p>
    						...
    						<p><a href="<?php echo site_url('DeliverySlipController');?>">Report</a></p>  
    						<p><a href="<?php echo site_url('DeliverySlipController');?>">Cash Receipt</a></p>
    						<p><a href="<?php echo site_url('DeliverySlipController');?>">Sale Return</a></p> 
    						<p><a href="<?php echo site_url('DeliverySlipController');?>">View Stock</a></p>
    			...
    			<a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
    				<div class="dropdown">
    					...
    					<div class="dropdown-content">
    						<p><a href="<?php echo site_url('SrController');?>">Sales Return Details</a></p>      
    						<p><a href="<?php echo site_url('SrController/USRItemDetails');?>">USR Item Details</a></p>
    			...
    			<a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
    				<div class="dropdown">
    					...
    					<div class="dropdown-content">
    						<p><a href="<?php echo site_url('EmployeeController/EmployeeLedger');?>">Ledger</a></p>      
    						<!-- <p><a href="<?php echo site_url('');?>">Salary slip</a></p> -->
    						<p><a href="<?php echo site_url('EmployeeController/EmployeeDetail');?>">Employee Details</a></p>  
    					</div>
    				</div> 
    			</a>
