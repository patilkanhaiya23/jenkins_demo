                          ...
                          <a href="">
                            ...
                            <div class="table-responsive">
                                ...
                                <table style="font-size: 11px" class="table table-bordered table-striped table-hover display nowrap" data-page-length='100'>
                                    <thead>
                                    <tr>
                                        <th colspan="4"><center>Cheque Reconcilliation</center></th>
                                    </tr>
                                    <tr>
                                        <th>Retailer Name</th>
                                        <th>Amount</th>
                                ...
                                <table style="font-size: 11px" class="table table-bordered table-striped table-hover js-basic-example DataTable display nowrap" id="example" data-page-length='100'>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" id="expenses"><?php if(!empty($expenses)){echo $expenses;} ?></td>
...
<script type="text/javascript">
  function calMoney() {
    ...
    var short=parseFloat(cashtotal)-parseFloat(expenses);
    var finalshortCash=(parseFloat(short)-parseFloat(total));
