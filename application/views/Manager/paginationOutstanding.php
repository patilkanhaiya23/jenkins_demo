                                         ...
                                         <?php if($data['isAllocated']==1){ ?>
                                            ...
                                            <td><?php echo $data['salesman'];?></td>
                                             ...
                                             <td>
                                                ...
                                                //     echo '<p style="color:blue">Allocated</p>';
                                                // } else if($data['billCurrentStatus'] !==""){
                                                //     echo '<p style="color:green">'.$data['billCurrentStatus'].'</p>';
                                                // } else if($data['billCurrentStatus']=="" && $data['netAmount']==$data['pendingAmt'] && $data['isDirectDeliveryBill']=="0" && $data['isResendBill']=="0"){
                                                //     echo '<p style="color:red">Unaacounted</p>';
                                                // } else if($data['billCurrentStatus']=="" && $data['netAmount']==$data['pendingAmt'] && $data['isDirectDeliveryBill']=="1"){
                                                //     echo '<p style="color:green">Direct Delivery</p>';
                                                // } else if($data['isLostBill']==1){
