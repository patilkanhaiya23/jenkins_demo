                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <p><a href="<?php echo site_url('cashier/CashAndChequeController/openAllocations');?>">Open Allocations</a></p>  
                            <p><a href="<?php echo site_url('cashier/CashAndChequeController/closedAllocations');?>">Closed Allocations</a></p>  
                        </div>
                    </div> 
                </a>
               ...
               <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <p><a href="<?php echo site_url('cashier/CashAndChequeController/BounceCheques');?>">Bounce Cheques</a></p>  
                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <p><a href="<?php echo site_url('cashier/DeliverySlipController/OutstandingBill');?>">Outstanding Bills</a></p>
                    </div>
                  </div> 
                </a>
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <p><a href="<?php echo site_url('CashAndChequeController');?>">Bounced Check</a></p> 
                        <p><a href="<?php echo site_url('cashier/CashBookController/CashReceipt');?>">Cash Receipts </a></p> 
