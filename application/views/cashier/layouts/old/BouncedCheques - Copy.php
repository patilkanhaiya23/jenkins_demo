<!DOCTYPE html>
<?php 
include('layouts/headerManager.php');
?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered" id="tbl">
                                                <tr class="head">
                                                    <td colspan="13" style="background-color: whitesmoke;"><b> Bounced Cheque Register </b></td>
                                                </tr>
                                                <tr class="gray">
                                                    <th> S No.</th>
                                                    <th> BillNo</th>
                                                ...
                                                <tr>
                                                   <td><?php echo $no; ?></td>
                                                    ...
                                                    <td>
                                                            <?php $id = $data['id'];
                                                            $status = "cleared";?>
                                                            <a href="<?php echo site_url('CashAndChequeController/updateStatusReturned/'.$id.'/'.$status);?>">
