    ...
    <nav class="navbar" >
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url('DashbordController');?>"><b>SmartD</b></a>
                <a class="navbar-brand" href="<?php echo site_url('AllocationByManagerController');?>">Allocation</a>
                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                      <p><a href="<?php echo site_url('AllocationByManagerController');?>">Review billwise</a></p>                   
                      <p><a href="<?php echo site_url('MakeBillwiseController');?>">Make billwise</a></p>  
                    </div>
                  </div> 
                </a>

                <a class="navbar-brand" href="<?php echo site_url('EmployeeController');?>">Employee</a>
              ...
              <!--   <a class="navbar-brand" href="<?php echo site_url('ReviewBillwiseController');?>">Review billwise</a>
                ...
                <a class="navbar-brand" href="<?php echo site_url('CashAndChequeController');?>">Cheque details</a>
                <a class="navbar-brand" href="<?php echo site_url('SalesReturnController');?>">Sales return</a>
                ...
                <a class="navbar-brand" href="<?php echo site_url('ReportsController');?>">Reports</a>
