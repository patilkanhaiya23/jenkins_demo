                    ...
                    <div class="card">
                       ...
                       <!--      <ul class="header-dropdown m-r--5">
                        ...
                        action="<?php
                            if(isset($employee))
                            {
                              echo site_url('godownKeeper/EmployeeController/update');
                            }
                            else
                            {
                            echo site_url('godownKeeper/EmployeeController/insert');
                            }
                        ?>"> 
                        <div class="body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row clearfix">
                                            <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                               ...
                                               <a href="<?php echo site_url('godownKeeper/EmployeeController/');?>">
