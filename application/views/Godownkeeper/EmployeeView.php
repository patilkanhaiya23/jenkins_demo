                                           ...
                                           <td><?php echo $no; ?></td>
                                            ...
                                            <td><?php echo $data['salary']; ?></td>
                                             ...
                                             <td><?php 
                                                ...
                                                $status1 = $data['status'];                    
                                                if($data['status']==1) {
                                                  echo "<a href=http://localhost:8080/smartdistributor/index.php/godownKeeper/EmployeeController/updateStatus/".$id."/".$status1.">Active</a>";
                                                } else {
                                                  echo "<a href=http://localhost:8080/smartdistributor/index.php/godownKeeper/EmployeeController/updateStatus/".$id."/".$status1.">Inactive</a>";
                                                }
                                              ?>     
                                            </td>
                                            <td>
                                            <a href="<?php echo base_url().'index.php/godownKeeper/EmployeeController/load/'.$data['id']; ?>">
...
.then((willDelete) => {
  if (willDelete) {
    $.ajax({
        url: "<?php echo site_url('godownKeeper/EmployeeController/delete');?>",
        type: "post",
        data: {'id':id},
        success: function (response) {
          ...
          var URL = "<?php echo site_url('godownKeeper/EmployeeController');?>";
