                                    ...
                                    foreach ($allocations as $data) 
                                      {
                                           ...
                                           for($i=0;$i<count($rtName);$i++){
                                                $routes=$this->GodownKeeperModel->getRouteName($rtName[$i]);
                                                if(!empty($routes)){
                                            ...
                                            if(($data['fieldStaffCode1'] !='0')){
                                                $emp=$this->GodownKeeperModel->getEmployeeNamesByID($data['fieldStaffCode1']);
                                                $employee= $employee.$emp.', ';
                                            }
                                            if(($data['fieldStaffCode2'] !='0')){
                                                $emp=$this->GodownKeeperModel->getEmployeeNamesByID($data['fieldStaffCode2']);
                                                $employee=$employee.$emp.', ';
                                            }
                                       ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- <a href="<?php echo base_url().'index.php/godownkeeper/GodownKeeperController/CompleteAllocation/'.$data['id']; ?>"><?php echo $data['allocationCode']; ?></a> -->
                                            </td>
                                        ...
                                        <!--  <?php 
                                        if($data['managerHisaabStatus']==1 && $data['gkStatus']==0){ ?>
                                            <td><center><i class="material-icons">check</i></center></td> 
                                        <?php }else{  ?>
                                            <td></td>
                                        <?php } ?> -->
                                        ...
                                        <?php  if($data['gkStatus']==1){  ?>
                                            <td><center><i class="material-icons">check</i></center></td>
                                        <?php }else if($data['managerHisaabStatus']==1 && $data['gkStatus']==0){ ?>
                                                <td><center><a href="<?php echo base_url().'index.php/godownkeeper/GodownKeeperController/GodownkeeperBills/'.$data['id']?>"><i class="material-icons">add</i></a></center></td>
                                        <?php  }else{ ?>
