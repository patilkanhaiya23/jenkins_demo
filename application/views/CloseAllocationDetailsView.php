        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix" id="page">
              ...
              ?></td>
                                            ...
                                            <td><?php echo number_format(round((($data['netAmount']+$data['chequePenalty'])-($cashAmt+$chequeAmt+$neftAmt+round($srAmount))))); ?></td>
            ...
            <?php  }
              ?></td>
                                            ...
                                            <td align="right"><?php echo number_format(($data['pendingAmt']+$cashAmt+$chequeAmt+$neftAmt+round($srAmount))); ?></td>
                                           ...
                                           <!-- <td><?php echo round((($data['netAmount']+$data['chequePenalty'])-($cashAmt+$chequeAmt+$neftAmt+round($srAmount)))); ?></td> -->
                                            <td><?php if($data['netAmount']==round($srAmount)){ echo 'FSR'; }else{ echo trim($status,','); } ?></td>
                                           <!-- <td>
                                              <a href="<?php echo site_url('AllocationByManagerController/closedAllocationTrancationDetails/'.$allocations[0]['id'].'/'.$data['id']);?>">
                                              <button class="btn bg-primary margin">Show Details</button></a> 
