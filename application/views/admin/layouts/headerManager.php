    		...
    		<div class="navbar-header">
    			...
    			<a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
    				<div class="dropdown">
    					...
    					<div class="dropdown-content">
    						...
    						<p><a href="<?php echo site_url('manager/CashBookController/EVauchers');?>">E-Vouchers
                            </a></p>  
    			...
    			<a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <p><a href="<?php echo site_url('SrController');?>">Allocation Wise SR </a></p> 
                            <p><a href="<?php echo site_url('SrController/HistoricalSr');?>">Historical SR </a></p>     
                            <p><a href="<?php echo site_url('SrController/CurrentSr');?>">Current SR </a></p>
                        </div>
                    </div> 
                </a>
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <p><a href="<?php echo site_url('SrController/usr');?>">USR Bills</a></p> <p><a href="<?php echo site_url('SrController/resendBills');?>">Resend Bills</a></p> 
                            <p><a href="<?php echo site_url('SrController/lostBills');?>">Lost Bills</a></p>
                            <p><a href="<?php echo site_url('');?>">Lost Cheques</a></p>
                        </div>
                    </div> 
                </a>
    			<a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
    				<div class="dropdown">
    					...
    					<div class="dropdown-content">
    						<p><a href="<?php echo site_url('NonAllocationBillsController');?>">Tagged Bill</a></p>
    					</div>
    				</div> 
    			</a>
    			<a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
