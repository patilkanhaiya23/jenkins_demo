        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                         Upload Cheque/NEFT Data
                        </h2>
                    </div>
                    <div class="row clearfix">
                        <div class="body">
                        <form method="post" role="form"  enctype="multipart/form-data"  action="<?php echo site_url('admin/BillTransactionController/neftChequeTransactionDataUploading');?>"> 
                            <div class="col-md-12">
                                <div class="col-md-5">
                                    <b id="billsTitle"> Select File </b>
