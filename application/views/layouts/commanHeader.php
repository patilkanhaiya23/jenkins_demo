...
if (isset($this->session->userdata['logged_in'])) {
    ...
    // $distributorCode="";
    // $officeDetails = $this->ExcelModel->load('office_details','1');
    // if(!empty($officeDetails)){
    //     $distributorCode=$officeDetails[0]['distributorName'];
    // }
     // print_r($des);exit;;
} else {
...
<body class="theme-red zoom">
   ...
   <nav class="navbar navbar-expand-xs bg-light navbar-light">
        <div id="mySidenavForAll" class="sidenav">
            <a href="<?php echo base_url('AdHocController/billSearch'); ?>" target="_blank" id="searchButtonSideMenu">Search Bill</a>
            <a href="<?php echo base_url('AdHocController/allRetailerHistory'); ?>" target="_blank" id="researchButtonSideMenu">Retailer History</a>
        </div>
            ...
            ?>    
                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                    <div class="dropdown">
                        ...
                        <?php if ((in_array('owner', $des)) || (in_array('accountant', $des))){ ?>
                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                    <div class="dropdown">
                        ...
                        <?php if (in_array('owner', $des)) { ?>
                            <p><a href="<?php echo site_url('owner/MainCashBookController');?>">Main Cash Book
                            </a></p>
                        <?php } ?>
                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                    <div class="dropdown">
                        ...
                        <?php if (in_array('operator', $des) || in_array('owner', $des)){ ?>
                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <p><a href="<?php echo site_url('reports/ReportController/collectionReport');?>">Collection Report</a></p>
                            <p><a href="<?php echo site_url('reports/ReportController/billwiseReport');?>">Billwise Report</a></p>
                        </div>
                    </div> 
                </a>
                <?php } 
